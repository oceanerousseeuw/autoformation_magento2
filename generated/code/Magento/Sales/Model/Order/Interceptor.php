...
class Interceptor extends \Magento\Sales\Model\Order implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canCreditmemoForZeroTotal');
        if (!$pluginInfo) {
            return parent::canCreditmemoForZeroTotal($totalRefunded);
        } else {
            return $this->___callPlugins('canCreditmemoForZeroTotal', func_get_args(), $pluginInfo);
        }
    }
